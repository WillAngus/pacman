...
var getActColor = function(act) {
    if (gameMode == GAME_PACMAN) {
		...
		return getCrazyOttoActColor(act);
	}
};
...
var getCrazyOttoActColor = function(act) {
    act -= 1;
    var mapIndex = (act <= 1) ? act : (act%2)+2;
    var maps = [mapCrazyOtto1, mapCrazyOtto2, mapCrazyOtto3, mapCrazyOtto4];
    var map = maps[mapIndex];
    if (act >= 4) {
        return [
            {
...
var setNextCrazyOttoMap = function() {
    var maps = [mapCrazyOtto1, mapCrazyOtto2, mapCrazyOtto3, mapCrazyOtto4];
...
var mapCrazyOtto1 = new Map(28, 36, (
    "____________________________" +
    "____________________________" +
    "____________________________" +
    "||||||||||||||||||||||||||||" +
...
mapCrazyOtto1.name = "Crazy Otto 1";
mapCrazyOtto1.wallFillColor = "#A21D3C";
mapCrazyOtto1.wallStrokeColor = "#F75F40";
mapCrazyOtto1.pelletColor = "#E4C622";
mapCrazyOtto1.fruitPaths = {
             "entrances": [
                 { "start": { "y": 164, "x": 228 }, "path": "<<<<vvv<<<<<<<<<^^^" },
                 { "start": { "y": 164, "x": -4 }, "path": ">>>>vvvvvv>>>>>>>>>>>>>>>^^^<<<^^^" },
                 { "start": { "y": 92, "x": -4 }, "path": ">>>>^^^^>>>vvvv>>>vvv>>>>>>>>>vvvvvv<<<" },
...
var mapCrazyOtto2 = new Map(28, 36, (
    "____________________________" +
    "____________________________" +
    "____________________________" +
    "||||||||||||||||||||||||||||" +
...
mapCrazyOtto2.name = "Crazy Otto 2";
mapCrazyOtto2.wallFillColor = "#96C989";
mapCrazyOtto2.wallStrokeColor = "#5C8156";
mapCrazyOtto2.pelletColor = "#F0E3A7";
mapCrazyOtto2.fruitPaths = {
             "entrances": [
                 { "start": { "y": 212, "x": 228 }, "path": "<<<<^^^<<<<<<<<^^^<" },
                 { "start": { "y": 212, "x": -4 }, "path": ">>>>^^^>>>>>>>>vvv>>>>>^^^^^^<" },
                 { "start": { "y": 36, "x": -4 }, "path": ">>>>>>>vvv>>>vvvvvvv>>>>>>>>>vvvvvv<<<" },
...
var mapCrazyOtto3 = new Map(28, 36, (
    "____________________________" +
    "____________________________" +
    "____________________________" +
    "||||||||||||||||||||||||||||" +
...
mapCrazyOtto3.name = "Crazy Otto 3";
mapCrazyOtto3.wallFillColor = "#F6EECD";
mapCrazyOtto3.wallStrokeColor = "#CCB385";
mapCrazyOtto3.pelletColor = "#e9212e";
mapCrazyOtto3.fruitPaths = {
             "entrances": [
                 { "start": { "y": 100, "x": 228 }, "path": "<<<<<vv<<<<<vvvvvv<<<" },
                 { "start": { "y": 100, "x": -4 }, "path": ">>>>>vv>>>>>>>>>>>>>>vvvvvv<<<" },
                 { "start": { "y": 100, "x": -4 }, "path": ">>>>>vv>>>>>>>>>>>>>>vvvvvv<<<" },
...
mapCrazyOtto3.constrainGhostTurns = function(tile,openTiles,dirEnum) {
    // prevent ghost from turning down when exiting tunnels
    if (tile.y == 12) {
        if ((tile.x == 1 && dirEnum == DIR_RIGHT) || (tile.x == 26 && dirEnum == DIR_LEFT)) {
            openTiles[DIR_DOWN] = false;
...
var mapCrazyOtto4 = new Map(28, 36, (
    "____________________________" +
    "____________________________" +
    "____________________________" +
    "||||||||||||||||||||||||||||" +
...
mapCrazyOtto4.name = "Crazy Otto 4";
mapCrazyOtto4.wallFillColor = "#57b38b";
mapCrazyOtto4.wallStrokeColor = "#2B5C4F";
mapCrazyOtto4.pelletColor = "#ff9452";
mapCrazyOtto4.fruitPaths = {
             "entrances": [
                 { "start": { "y": 156, "x": 228 }, "path": "<<<<vv<<<vv<<<<<<^^^" },
                 { "start": { "y": 156, "x": -4 }, "path": ">>>>vv>>>vv>>>>>>vvv>>>^^^^^^" },
                 { "start": { "y": 132, "x": -4 }, "path": ">>>>^^^^^>>>^^^>>>vvv>>>vvv>>>>>>vvvvvv<<<" },
